...
public class Customer {
	...
	public String toString() {
		return "Customer [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", street=" + street
				...
				+ phone + ", getId()=" + getId() + ", getFirstName()=" + getFirstName() + ", getLastName()="
				+ getLastName() + ", getStreet()=" + getStreet() + ", getAddress()=" + getAddress() + ", getCity()="
				+ getCity() + ", getState()=" + getState() + ", getEmail()=" + getEmail() + ", getPhone()=" + getPhone()
